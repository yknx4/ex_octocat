...
defmodule ExOctocat.Api.Scim do
  @moduledoc """
  ...
  @spec scim_delete_user_from_org(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, nil} | {:ok, ExOctocat.Model.ScimError.t()} | {:error, Tesla.Env.t()}
  def scim_delete_user_from_org(connection, org, scim_user_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {204, false},
      {404, %ExOctocat.Model.ScimError{}},
      {403, %ExOctocat.Model.ScimError{}},
      {304, false}
    ])
  end
  ...
  {:ok, ExOctocat.Model.ScimUser.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec scim_get_provisioning_information_for_user(
          ...
          {:ok, nil}
          | {:ok, ExOctocat.Model.ScimError.t()}
          | {:ok, ExOctocat.Model.ScimUser.t()}
          | {:error, Tesla.Env.t()}
  ...
  {:ok, ExOctocat.Model.ScimUserList.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec scim_list_provisioned_identities(Tesla.Env.client(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, ExOctocat.Model.ScimError.t()}
          | {:ok, ExOctocat.Model.ScimUserList.t()}
          | {:error, Tesla.Env.t()}
  def scim_list_provisioned_identities(connection, org, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {200, %ExOctocat.Model.ScimUserList{}},
      {304, false},
      {404, %ExOctocat.Model.ScimError{}},
      {403, %ExOctocat.Model.ScimError{}},
      {400, %ExOctocat.Model.ScimError{}}
    ])
  end
  ...
  def scim_provision_and_invite_user(connection, org, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      {201, %ExOctocat.Model.ScimUser{}},
      {304, false},
      {404, %ExOctocat.Model.ScimError{}},
      {403, %ExOctocat.Model.ScimError{}},
      {500, %ExOctocat.Model.ScimError{}},
      {409, %ExOctocat.Model.ScimError{}},
      {400, %ExOctocat.Model.ScimError{}}
    ])
  end
  ...
  def scim_update_attribute_for_user(connection, org, scim_user_id, opts \\ []) do
    ...
    |> evaluate_response([
      ...
      {403, %ExOctocat.Model.ScimError{}},
      {400, %ExOctocat.Model.ScimError{}},
      {429, %ExOctocat.Model.BasicError{}}
    ])
  end
end
