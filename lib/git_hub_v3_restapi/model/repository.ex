...
defmodule ExOctocat.Model.Repository do
  @moduledoc """
  A git repository
  """
  ...
  @type t :: %__MODULE__{
          ...
          :forks => integer(),
          :permissions => ExOctocat.Model.RepositoryPermissions.t() | nil,
          ...
          :template_repository => ExOctocat.Model.RepositoryTemplateRepository.t() | nil,
...
defimpl Poison.Decoder, for: ExOctocat.Model.Repository do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:permissions, :struct, ExOctocat.Model.RepositoryPermissions, options)
    |> deserialize(:owner, :struct, ExOctocat.Model.SimpleUser, options)
    |> deserialize(
      :template_repository,
      :struct,
      ExOctocat.Model.RepositoryTemplateRepository,
      options
    )
  end
end
