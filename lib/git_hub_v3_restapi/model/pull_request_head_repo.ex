...
defmodule ExOctocat.Model.PullRequestHeadRepo do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :owner => ExOctocat.Model.PullRequestHeadRepoOwner.t(),
          :private => boolean(),
          :pulls_url => String.t(),
          ...
          :license => ExOctocat.Model.PullRequestHeadRepoLicense.t() | nil,
...
defimpl Poison.Decoder, for: ExOctocat.Model.PullRequestHeadRepo do
  import ExOctocat.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:owner, :struct, ExOctocat.Model.PullRequestHeadRepoOwner, options)
    |> deserialize(
      :permissions,
      :struct,
    ...
    |> deserialize(:license, :struct, ExOctocat.Model.PullRequestHeadRepoLicense, options)
  end
end
