...
defmodule ExOctocat.Model.Feed do
  @moduledoc """
  Feed
  """
  ...
  @type t :: %__MODULE__{
          ...
          :_links => ExOctocat.Model.FeedLinks.t()
        }
end

defimpl Poison.Decoder, for: ExOctocat.Model.Feed do
  import ExOctocat.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:_links, :struct, ExOctocat.Model.FeedLinks, options)
  end
end
