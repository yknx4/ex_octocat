...
defmodule ExOctocat.Model.Import do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :project_choices => [ExOctocat.Model.ImportProjectChoices.t()] | nil,
...
defimpl Poison.Decoder, for: ExOctocat.Model.Import do
  import ExOctocat.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:project_choices, :list, ExOctocat.Model.ImportProjectChoices, options)
  end
end
