...
defmodule ExOctocat.Model.PrivateUser do
  @moduledoc """
  Private User
  """
  ...
  @type t :: %__MODULE__{
          ...
          :plan => ExOctocat.Model.PublicUserPlan.t() | nil,
...
defimpl Poison.Decoder, for: ExOctocat.Model.PrivateUser do
  import ExOctocat.Deserializer

  def decode(value, options) do
    value
    |> deserialize(:plan, :struct, ExOctocat.Model.PublicUserPlan, options)
  end
end
