...
defmodule ExOctocat.Model.InlineObject59 do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :security_and_analysis =>
            ExOctocat.Model.ReposOwnerRepoSecurityAndAnalysis.t() | nil,
...
defimpl Poison.Decoder, for: ExOctocat.Model.InlineObject59 do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :security_and_analysis,
      :struct,
      ExOctocat.Model.ReposOwnerRepoSecurityAndAnalysis,
      options
    )
  end
end
