...
defmodule ExOctocat.Model.FullRepository do
  @moduledoc """
  Full Repository
  """
  ...
  @type t :: %__MODULE__{
          ...
          :permissions => ExOctocat.Model.FullRepositoryPermissions.t() | nil,
          ...
          :parent => ExOctocat.Model.Repository.t() | nil,
          :source => ExOctocat.Model.Repository.t() | nil,
          :forks => integer(),
          :master_branch => String.t() | nil,
          :open_issues => integer(),
          :watchers => integer(),
          :anonymous_access_enabled => boolean() | nil,
          :code_of_conduct => ExOctocat.Model.CodeOfConductSimple.t() | nil,
          :security_and_analysis =>
            ExOctocat.Model.FullRepositorySecurityAndAnalysis.t() | nil
        }
end

defimpl Poison.Decoder, for: ExOctocat.Model.FullRepository do
  ...
  def decode(value, options) do
    ...
    |> deserialize(
      :permissions,
      :struct,
      ExOctocat.Model.FullRepositoryPermissions,
      options
    )
    ...
    |> deserialize(:organization, :struct, ExOctocat.Model.SimpleUser, options)
    |> deserialize(:parent, :struct, ExOctocat.Model.Repository, options)
    |> deserialize(:source, :struct, ExOctocat.Model.Repository, options)
    |> deserialize(:code_of_conduct, :struct, ExOctocat.Model.CodeOfConductSimple, options)
    |> deserialize(
      :security_and_analysis,
      :struct,
      ExOctocat.Model.FullRepositorySecurityAndAnalysis,
      options
    )
  end
end
